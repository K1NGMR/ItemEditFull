...
public class NewExpansionAbilities implements Listener {
    ...
    private static final Map<UUID, Long> piglinRageActive = new java.util.concurrent.ConcurrentHashMap<>();
    private static final Map<UUID, Long> activeBreezeDeflects = new java.util.concurrent.ConcurrentHashMap<>();
    private static final List<Location> magmaTrailLocations = new ArrayList<>();

    @EventHandler
    public void onQuit(org.bukkit.event.player.PlayerQuitEvent event) {
        UUID id = event.getPlayer().getUniqueId();
        piglinRageActive.remove(id);
        activeBreezeDeflects.remove(id);
    }
...
class MagmaShield extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        ...
        EffectUtils.ring(loc, 1.2, 16, new Layer(Particle.LAVA, 1, 0, 0, 0, 0));
        EffectUtils.burst(loc.add(0, 1.0, 0),
                new Layer(Particle.FLAME, 18, 0.4, 0.6, 0.4, 0.02),
                new Layer(Particle.SMOKE_LARGE, 6, 0.3, 0.3, 0.3, 0.01));
        p.getWorld().playSound(p.getLocation(), Sound.ITEM_FIRECHARGE_USE, 1f, 1f);
        p.getWorld().playSound(p.getLocation(), Sound.BLOCK_FIRE_AMBIENT, 0.8f, 0.7f);
        return true;
    }
}
class MagmaJump extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        ...
        EffectUtils.burst(loc,
                new Layer(Particle.FLAME, 20, 0.5, 0.5, 0.5, 0.1),
                new Layer(Particle.LAVA, 6, 0.3, 0.1, 0.3, 0),
                new Layer(Particle.CLOUD, 10, 0.3, 0.1, 0.3, 0.02));
        p.getWorld().playSound(loc, Sound.ENTITY_BLAZE_SHOOT, 1.0f, 1.4f);
        return true;
    }
}
...
class MagmaFist extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        Location loc = p.getLocation().add(p.getLocation().getDirection().multiply(1.2)).add(0, 1.0, 0);
        EffectUtils.burst(loc,
                new Layer(Particle.EXPLOSION_NORMAL, 1, 0.1, 0.1, 0.1, 0),
                new Layer(Particle.LAVA, 5, 0.2, 0.2, 0.2, 0),
                new Layer(Particle.FLAME, 12, 0.3, 0.3, 0.3, 0.02));
        p.getWorld().playSound(p.getLocation(), Sound.ENTITY_BLAZE_AMBIENT, 0.8f, 1.1f);
...
class BlazeSpeed extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        ...
        Location loc = p.getLocation();
        EffectUtils.burst(loc,
                new Layer(Particle.FLAME, 15, 0.2, 0.2, 0.2, 0.1),
                new Layer(Particle.FIREWORK_SPARK, 10, 0.3, 0.2, 0.3, 0.08));
        p.getWorld().playSound(loc, Sound.ENTITY_BLAZE_SHOOT, 1.0f, 1.6f);
        return true;
    }
}
...
class BlazeFlight extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        ...
        Location loc = p.getLocation();
        EffectUtils.burst(loc,
                new Layer(Particle.FLAME, 25, 0.3, 0.5, 0.3, 0.05),
                new Layer(Particle.SMOKE_LARGE, 10, 0.2, 0.4, 0.2, 0.02));
        p.getWorld().playSound(loc, Sound.ENTITY_BLAZE_BURN, 1.0f, 1.2f);
        return true;
    }
}
class BlazeBarrage extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        ...
        EffectUtils.burst(loc,
                new Layer(Particle.FLAME, 12, 0.15, 0.15, 0.15, 0.02),
                new Layer(Particle.SMOKE_LARGE, 5, 0.1, 0.1, 0.1, 0.01));
        p.getWorld().playSound(loc, Sound.ENTITY_BLAZE_SHOOT, 1.0f, 1.0f);
...
class GhastFloat extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        ...
        Location loc = p.getLocation();
        EffectUtils.ring(loc, 1.0, 12, new Layer(Particle.CLOUD, 1, 0, 0.1, 0, 0.01));
        EffectUtils.burst(loc, new Layer(Particle.END_ROD, 8, 0.3, 0.2, 0.3, 0.01));
        p.getWorld().playSound(loc, Sound.ENTITY_GHAST_AMBIENT, 0.8f, 1.3f);
        return true;
    }
}
...
class GhastScream extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        Location loc = p.getLocation();
        EffectUtils.ring(loc, 2.5, 20, new Layer(Particle.SMOKE_LARGE, 1, 0.05, 0.1, 0.05, 0.01));
        EffectUtils.burst(loc.add(0, 1.0, 0), new Layer(Particle.CLOUD, 20, 0.4, 0.4, 0.4, 0.05));
        p.getWorld().playSound(p.getLocation(), Sound.ENTITY_GHAST_SCREAM, 1.5f, 1f);
...
class GhastTear extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        ...
        EffectUtils.burst(loc,
                new Layer(Particle.HEART, 6, 0.3, 0.3, 0.3, 0),
                new Layer(Particle.VILLAGER_HAPPY, 10, 0.3, 0.3, 0.3, 0));
        p.getWorld().playSound(loc, Sound.ENTITY_PLAYER_LEVELUP, 0.6f, 1.6f);
        return true;
    }
}
class PiglinGreed extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        ...
        Location loc = p.getLocation();
        EffectUtils.burst(loc,
                new Layer(Particle.CRIT_MAGIC, 14, 0.3, 0.4, 0.3, 0.05),
                new Layer(Particle.VILLAGER_HAPPY, 8, 0.3, 0.3, 0.3, 0));
        p.getWorld().playSound(loc, Sound.ENTITY_PIGLIN_ADMIRING_ITEM, 1.0f, 1.2f);
        return true;
    }
}
class PiglinCrossbow extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        Location loc = p.getEyeLocation();
        EffectUtils.burst(loc, new Layer(Particle.CRIT, 8, 0.1, 0.1, 0.1, 0.05));
        p.getWorld().playSound(loc, Sound.ITEM_CROSSBOW_SHOOT, 1.0f, 1.1f);
...
class PiglinRage extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        Location loc = p.getLocation();
        EffectUtils.ring(loc, 1.4, 14, new Layer(Particle.FLAME, 1, 0, 0.1, 0, 0.01));
        EffectUtils.burst(loc.add(0, 1.0, 0), new Layer(Particle.DAMAGE_INDICATOR, 10, 0.3, 0.3, 0.3, 0));
        p.getWorld().playSound(loc, Sound.ENTITY_PIGLIN_ANGRY, 1.0f, 0.8f);
        return true;
    }
}
class PiglinBarter extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        ...
        Location loc = p.getLocation().add(0, 1.0, 0);
        EffectUtils.burst(loc,
                new Layer(Particle.VILLAGER_HAPPY, 16, 0.4, 0.4, 0.4, 0),
                new Layer(Particle.END_ROD, 4, 0.2, 0.2, 0.2, 0.01));
        p.getWorld().playSound(loc, Sound.ENTITY_PIGLIN_ADMIRING_ITEM, 1.2f, 1.5f);
        return true;
    }
}
class NetherQuake extends Ability {
    private final ItemEditFull plugin;
    public NetherQuake(ItemEditFull pl) { super("nether_quake", "Nether Quake", "Slam waves."); this.plugin = pl; }
    @Override public boolean trigger(Player p, ItemStack i) {
        Location center = p.getLocation();
        p.getWorld().playSound(center, Sound.ENTITY_ZOMBIE_BREAK_WOODEN_DOOR, 1.2f, 0.6f);
        p.getWorld().playSound(center, Sound.ENTITY_WITHER_SHOOT, 0.6f, 0.4f);
        EffectUtils.staggered(plugin, p, 3, 3L, idx -> {
            double radius = 1.5 + idx * 1.5;
            EffectUtils.ring(center, radius, 20, new Layer(Particle.SMOKE_LARGE, 1, 0, 0.05, 0, 0.01));
            EffectUtils.ring(center, radius, 20, new Layer(Particle.CRIT, 1, 0, 0.1, 0, 0.02));
        });
        return true;
    }
}
class NetherHeat extends Ability {
    private final ItemEditFull plugin;
    public NetherHeat(ItemEditFull pl) { super("nether_heat", "Nether Heat", "Igniation aura."); this.plugin = pl; }
    @Override public boolean trigger(Player p, ItemStack i) {
        Location loc = p.getLocation();
        EffectUtils.spiral(plugin, p, loc, 1.5, 16, Math.PI / 8, 0.1, 1L,
                new Layer(Particle.FLAME, 3, 0.05, 0.05, 0.05, 0.01));
        p.getWorld().playSound(loc, Sound.BLOCK_FIRE_AMBIENT, 1.0f, 0.9f);
        return true;
    }
}
class NetherPortalRift extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        ...
        EffectUtils.burst(start,
                new Layer(Particle.PORTAL, 25, 0.3, 0.6, 0.3, 0.4),
                new Layer(Particle.SPELL_WITCH, 8, 0.2, 0.4, 0.2, 0));
        p.getWorld().playSound(start, Sound.ENTITY_ENDERMAN_TELEPORT, 1.0f, 0.9f);
        p.teleport(p.getLocation().add(p.getLocation().getDirection().multiply(range)));
        Location end = p.getLocation();
        EffectUtils.burst(end,
                new Layer(Particle.PORTAL, 25, 0.3, 0.6, 0.3, 0.4),
                new Layer(Particle.REVERSE_PORTAL, 10, 0.2, 0.4, 0.2, 0.1));
        p.getWorld().playSound(end, Sound.ENTITY_ENDERMAN_TELEPORT, 1.0f, 1.2f);
        return true;
    }
}
class NetherSoulDrain extends Ability {
    private final ItemEditFull plugin;
    public NetherSoulDrain(ItemEditFull pl) { super("nether_soul_drain", "Nether Soul Drain", "Drain life force."); this.plugin = pl; }
    @Override public boolean trigger(Player p, ItemStack i) {
        Location loc = p.getLocation();
        EffectUtils.ring(loc, 2.0, 18, new Layer(Particle.SOUL, 1, 0, 0.1, 0, 0.01));
        EffectUtils.burst(loc.add(0, 1.0, 0), new Layer(Particle.SOUL_FIRE_FLAME, 10, 0.3, 0.4, 0.3, 0.02));
        p.getWorld().playSound(loc, Sound.BLOCK_SOUL_SAND_BREAK, 1.0f, 0.7f);
        return true;
    }
}
...
class GuardianBeam extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        ...
        for (int k = 1; k <= 6; k++) {
            ...
            EffectUtils.burst(step, new Layer(Particle.WATER_BUBBLE, 4, 0.1, 0.1, 0.1, 0));
        }
        EffectUtils.burst(loc, new Layer(Particle.SPELL_INSTANT, 10, 0.1, 0.1, 0.1, 0));
        p.getWorld().playSound(loc, Sound.ENTITY_GUARDIAN_ATTACK, 1.2f, 1.0f);
        return true;
    }
}
class GuardianThorns extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        Location loc = p.getLocation();
        EffectUtils.ring(loc, 1.3, 14, new Layer(Particle.WATER_SPLASH, 1, 0, 0.1, 0, 0.01));
        p.getWorld().playSound(loc, Sound.ENTITY_GUARDIAN_HURT, 1.0f, 1.3f);
        return true;
    }
}
class ElderGuardianFatigue extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        Location loc = p.getLocation();
        EffectUtils.burst(loc.add(0, 1.0, 0),
                new Layer(Particle.SPELL_MOB, 12, 0.4, 0.5, 0.4, 0),
                new Layer(Particle.WATER_BUBBLE, 8, 0.3, 0.4, 0.3, 0));
        p.getWorld().playSound(loc, Sound.ENTITY_ELDER_GUARDIAN_CURSE, 1.0f, 0.8f);
        return true;
    }
}
class ElderGuardianGhost extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        Location loc = p.getLocation();
        EffectUtils.ring(loc, 2.2, 16, new Layer(Particle.SPELL_WITCH, 1, 0, 0.2, 0, 0.01));
        p.getWorld().playSound(loc, Sound.ENTITY_ELDER_GUARDIAN_CURSE, 1.4f, 0.6f);
        return true;
    }
}
class DrownedTridentAbility extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        Location loc = p.getEyeLocation();
        EffectUtils.burst(loc, new Layer(Particle.WATER_BUBBLE, 12, 0.15, 0.15, 0.15, 0.05));
        p.getWorld().playSound(loc, Sound.ITEM_TRIDENT_THROW, 1.0f, 1.0f);
...
class DrownedWaterLeap extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        ...
        p.setVelocity(new Vector(0, velocity, 0));
        Location loc = p.getLocation();
        EffectUtils.ring(loc, 1.0, 12, new Layer(Particle.WATER_SPLASH, 1, 0, 0, 0, 0.05));
        p.getWorld().playSound(loc, Sound.ENTITY_DROWNED_SWIM, 1.0f, 1.2f);
        return true;
    }
}
class DrownedConduitPower extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        ...
        Location loc = p.getLocation();
        EffectUtils.burst(loc.add(0, 1.0, 0),
                new Layer(Particle.WATER_BUBBLE, 14, 0.4, 0.4, 0.4, 0.02),
                new Layer(Particle.END_ROD, 5, 0.2, 0.3, 0.2, 0.01));
        p.getWorld().playSound(loc, Sound.BLOCK_CONDUIT_ACTIVATE, 1.0f, 1.0f);
        return true;
    }
}
class DrownedDepthStrider extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        ...
        Location loc = p.getLocation();
        EffectUtils.burst(loc, new Layer(Particle.WATER_BUBBLE, 10, 0.3, 0.2, 0.3, 0.05));
        p.getWorld().playSound(loc, Sound.ENTITY_DROWNED_SWIM, 0.8f, 1.4f);
        return true;
    }
}
class DolphinGraceAbility extends Ability {
    public DolphinGraceAbility(ItemEditFull pl) { super("dolphin_swiftness", "Dolphin Swiftness", "Speed in water."); }
    @Override public boolean trigger(Player p, ItemStack i) {
        double duration = getDoubleParam(i, "duration", 20.0);
        int amp = getIntParam(i, "amplifier", 0);
        p.addPotionEffect(new PotionEffect(PotionEffectType.DOLPHINS_GRACE, (int) (duration * 20), amp));
        Location loc = p.getLocation();
        EffectUtils.burst(loc, new Layer(Particle.WATER_BUBBLE, 10, 0.3, 0.3, 0.3, 0.02));
        p.getWorld().playSound(loc, Sound.ENTITY_DOLPHIN_PLAY, 1.0f, 1.2f);
        return true;
    }
}
class DolphinLeap extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        ...
        Location loc = p.getLocation();
        EffectUtils.burst(loc,
                new Layer(Particle.WATER_SPLASH, 20, 0.4, 0.2, 0.4, 0.1),
                new Layer(Particle.WATER_BUBBLE, 6, 0.3, 0.2, 0.3, 0.02));
        p.getWorld().playSound(loc, Sound.ENTITY_DOLPHIN_JUMP, 1.0f, 1.1f);
        return true;
    }
}
class DolphinSonic extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        Location loc = p.getLocation();
        EffectUtils.ring(loc, 1.8, 16, new Layer(Particle.WATER_BUBBLE, 1, 0, 0.15, 0, 0.02));
        p.getWorld().playSound(loc, Sound.ENTITY_DOLPHIN_ATTACK, 1.2f, 1.3f);
        return true;
    }
}
...
class SquidInkAbility extends Ability {
    public SquidInkAbility(ItemEditFull pl) { super("squid_ink_cloud", "Squid Ink Cloud", "Blind targets nearby."); }
    @Override public boolean trigger(Player p, ItemStack i) { return true; }
}
...
class BreezeGust extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        ...
        for (Entity ent : p.getWorld().getNearbyEntities(loc, radius, 2.0, radius)) {
            if (ent instanceof LivingEntity && !ent.equals(p)) {
                LivingEntity le = (LivingEntity) ent;
                Vector push = com.itemedit.full.utils.VectorUtils.safeNormalize(le.getLocation().toVector().subtract(loc.toVector())).multiply(pushVelocity).setY(pushY);
                le.setVelocity(push);
                le.damage(damage, p);
            }
        }
...
class BeeSwarmSummon extends Ability {
    public BeeSwarmSummon(ItemEditFull pl) { super("bee_swarm_summon", "Summon Bee Swarm", "Summon helpers."); }
    @Override public boolean trigger(Player p, ItemStack i) { return true; }
}
...
class StrayFreezeTouch extends Ability {
    private static final Map<UUID, Long> activeFreezeTouches = new java.util.concurrent.ConcurrentHashMap<>();
    private final ItemEditFull plugin;
...
class DesertCactusThorns extends Ability {
    private static final Map<UUID, Long> activeThorns = new java.util.concurrent.ConcurrentHashMap<>();
    private final ItemEditFull plugin;
...
class MeteorSlam extends Ability {
    private final ItemEditFull plugin;
    public MeteorSlam(ItemEditFull pl) { super("meteor_slam", "Meteor Slam", "Launches you skyward and slams back down as a living meteor, cracking the ground with a fiery shockwave."); this.plugin = pl; }
    @Override public boolean trigger(Player p, ItemStack i) {
        double launchVelocity = getDoubleParam(plugin, i, "launch_velocity", 1.4);
        double damage = getDoubleParam(plugin, i, "damage", 10.0);
        double radius = getDoubleParam(plugin, i, "radius", 5.0);
        double knockback = getDoubleParam(plugin, i, "knockback", 1.8);
        int maxWaitTicks = getIntParam(plugin, i, "max_wait_ticks", 100);

        p.setVelocity(new Vector(0, launchVelocity, 0));
        p.getWorld().playSound(p.getLocation(), Sound.ENTITY_ENDER_DRAGON_FLAP, 1.2f, 0.6f);
        ...
        new CompatRunnable() {
            ...
            @Override public void run() {
                ...
                if (ticks++ > maxWaitTicks) { cancel(); return; }
                if (!p.isOnGround()) {
                    airborne = true;
                    Location trail = p.getLocation().add(0, 0.2, 0);
                    trail.getWorld().spawnParticle(Particle.FLAME, trail, 6, 0.15, 0.15, 0.15, 0.02);
                    trail.getWorld().spawnParticle(Particle.CLOUD, trail, 3, 0.1, 0.1, 0.1, 0.01);
                    return;
                }
                if (!airborne) return; // still hasn't left the ground yet
                Location loc = p.getLocation();
                com.itemedit.full.utils.EffectUtils.burst(loc, com.itemedit.full.utils.EffectUtils.layers(
                        new com.itemedit.full.utils.EffectUtils.Layer(Particle.EXPLOSION_LARGE, 3, 0.3, 0.1, 0.3, 0),
                        new com.itemedit.full.utils.EffectUtils.Layer(Particle.FLAME, 40, 0.1, 0.1, 0.1, 0.15),
                        new com.itemedit.full.utils.EffectUtils.Layer(Particle.LAVA, 10, 0.2, 0.05, 0.2, 0)));
                com.itemedit.full.utils.EffectUtils.ring(loc, radius, 24,
                        new com.itemedit.full.utils.EffectUtils.Layer(Particle.FALLING_LAVA, 1, 0, 0, 0, 0));
                ...
                for (Entity e : loc.getWorld().getNearbyEntities(loc, radius, radius, radius)) {
                    if (e instanceof LivingEntity && !e.equals(p)) {
                        ...
                        le.damage(damage, p);
                        com.itemedit.full.utils.EffectUtils.knockback(le, loc, knockback, 0.6);
                    }
                }
                cancel();
            }
        ...
        new CompatRunnable() {
            ...
            @Override public void run() {
                ...
                for (Entity ent : center.getWorld().getNearbyEntities(center, radius, 3.0, radius)) {
                    if (ent instanceof LivingEntity && !ent.equals(p)) {
                        Vector pull = com.itemedit.full.utils.VectorUtils.safeNormalize(center.toVector().subtract(ent.getLocation().toVector())).multiply(pullForce);
...
class FrostGiantSlam extends Ability {
    private final ItemEditFull plugin;
    public FrostGiantSlam(ItemEditFull pl) { super("frost_giant_slam", "Frost Slam", "Slowness slam."); this.plugin = pl; }
    @Override public boolean trigger(Player p, ItemStack i) {
        Location loc = p.getLocation();
        double radius = getDoubleParam(i, "radius", 4.5);
        double damage = getDoubleParam(i, "damage", 6.0);
        int slowDuration = getIntParam(i, "slow_duration", 100);
        int slowAmp = getIntParam(i, "slow_amplifier", 3);
        com.itemedit.full.utils.EffectUtils.fanfare(loc,
            new com.itemedit.full.utils.EffectUtils.SoundLayer(Sound.ENTITY_IRON_GOLEM_ATTACK, 1.4f, 0.6f),
            new com.itemedit.full.utils.EffectUtils.SoundLayer(Sound.BLOCK_GLASS_BREAK, 1.2f, 0.5f));
        com.itemedit.full.utils.EffectUtils.burst(loc,
            new com.itemedit.full.utils.EffectUtils.Layer(Particle.SNOWBALL, 30, 1.0, 0.3, 1.0, 0.05),
            new com.itemedit.full.utils.EffectUtils.Layer(Particle.CLOUD, 15, 1.2, 0.2, 1.2, 0.02));
        com.itemedit.full.utils.EffectUtils.ring(loc, radius, 24,
            new com.itemedit.full.utils.EffectUtils.Layer(Particle.SNOWFLAKE, 3, 0.1, 0.4, 0.1, 0.01));
        for (Entity ent : loc.getWorld().getNearbyEntities(loc, radius, 2.0, radius)) {
            if (ent instanceof LivingEntity && !ent.equals(p)) {
                LivingEntity le = (LivingEntity) ent;
                le.damage(damage, p);
...
class VampiricEdge extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        ...
        double damage = getDoubleParam(i, "damage", 6.0);
        double healPercent = getDoubleParam(i, "heal_percent", 0.5);
        Location loc = (le != null) ? le.getLocation().add(0, 1, 0) : p.getEyeLocation().add(p.getLocation().getDirection().normalize().multiply(3));
        p.getWorld().playSound(p.getLocation(), Sound.ENTITY_PLAYER_ATTACK_SWEEP, 1.0f, 0.7f);
        com.itemedit.full.utils.EffectUtils.burst(loc,
            new com.itemedit.full.utils.EffectUtils.Layer(Particle.SPELL_WITCH, 15, 0.3, 0.4, 0.3, 0.05),
            new com.itemedit.full.utils.EffectUtils.Layer(Particle.CRIT, 10, 0.3, 0.3, 0.3, 0.05),
            new com.itemedit.full.utils.EffectUtils.Layer(Particle.REDSTONE, 20, 0.3, 0.4, 0.3, 0.0,
                new Particle.DustOptions(Color.fromRGB(139, 0, 0), 1.4f)));
        if (le != null) {
            le.damage(damage, p);
            double healed = damage * healPercent;
            p.setHealth(Math.min(p.getMaxHealth(), p.getHealth() + healed));
            loc.getWorld().spawnParticle(Particle.HEART, p.getLocation().add(0, 2, 0), 6, 0.3, 0.3, 0.3, 0.01);
            p.getWorld().playSound(p.getLocation(), Sound.ENTITY_GENERIC_DRINK, 1.0f, 1.4f);
        }
        return true;
    }
}
class ReaperScythe extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        Entity target = p.getTargetEntity(5);
        final LivingEntity le = (target instanceof LivingEntity) ? (LivingEntity) target : null;
        double damage = getDoubleParam(i, "damage", 7.0);
        double executeThreshold = getDoubleParam(i, "execute_threshold", 0.25);
        Location loc = (le != null) ? le.getLocation().add(0, 1, 0) : p.getEyeLocation().add(p.getLocation().getDirection().normalize().multiply(3));
        p.getWorld().playSound(p.getLocation(), Sound.ENTITY_PLAYER_ATTACK_SWEEP, 1.2f, 0.5f);
        com.itemedit.full.utils.EffectUtils.burst(loc,
            new com.itemedit.full.utils.EffectUtils.Layer(Particle.SMOKE_LARGE, 12, 0.3, 0.4, 0.3, 0.02),
            new com.itemedit.full.utils.EffectUtils.Layer(Particle.SOUL, 15, 0.3, 0.4, 0.3, 0.02),
            new com.itemedit.full.utils.EffectUtils.Layer(Particle.CRIT, 10, 0.3, 0.3, 0.3, 0.05));
        if (le != null) {
            boolean lethal = (le.getHealth() / le.getMaxHealth()) <= executeThreshold;
            if (lethal) {
                le.setHealth(0.0);
                loc.getWorld().spawnParticle(Particle.SOUL_FIRE_FLAME, loc, 25, 0.4, 0.6, 0.4, 0.05);
                loc.getWorld().playSound(loc, Sound.ENTITY_WITHER_DEATH, 1.0f, 1.6f);
            } else {
                le.damage(damage, p);
            }
        }
...
class ExecutionerChop extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        ...
        final LivingEntity le = (target instanceof LivingEntity) ? (LivingEntity) target : null;
        double damage = getDoubleParam(i, "damage", 5.0);
        double critMultiplier = getDoubleParam(i, "crit_multiplier", 2.0);
        Location loc = (le != null) ? le.getLocation().add(0, 1, 0) : p.getEyeLocation().add(p.getLocation().getDirection().normalize().multiply(3));
        p.getWorld().playSound(p.getLocation(), Sound.ENTITY_ZOMBIE_ATTACK_IRON_DOOR, 1.2f, 1.6f);
        com.itemedit.full.utils.EffectUtils.burst(loc,
            new com.itemedit.full.utils.EffectUtils.Layer(Particle.CRIT_MAGIC, 25, 0.3, 0.4, 0.3, 0.1),
            new com.itemedit.full.utils.EffectUtils.Layer(Particle.CRIT, 20, 0.3, 0.4, 0.3, 0.1),
            new com.itemedit.full.utils.EffectUtils.Layer(Particle.FLASH, 1, 0.0, 0.0, 0.0, 0.0));
        if (le != null) {
            le.damage(damage * critMultiplier, p);
        }
        return true;
    }
}
class GravityPullStrike extends Ability {
    private final ItemEditFull plugin;
    public GravityPullStrike(ItemEditFull pl) { super("gravity_pull_strike", "Gravity Pull", "Pulls targets."); this.plugin = pl; }
    @Override public boolean trigger(Player p, ItemStack i) {
        Location center = p.getEyeLocation().add(p.getLocation().getDirection().normalize().multiply(6));
        double radius = getDoubleParam(i, "radius", 6.0);
        double pullForce = getDoubleParam(i, "pull_force", 0.6);
        double damage = getDoubleParam(i, "damage", 3.0);
        p.getWorld().playSound(center, Sound.ENTITY_ENDERMAN_TELEPORT, 1.2f, 0.6f);
        com.itemedit.full.utils.EffectUtils.spiral(plugin, p, center, radius, 20, Math.PI / 6, -0.05, 1L,
            new com.itemedit.full.utils.EffectUtils.Layer(Particle.PORTAL, 6, 0.05, 0.05, 0.05, 0.05));
        new CompatRunnable() {
            int ticks = 0;
            @Override public void run() {
                if (ticks++ > 25) { cancel(); return; }
                center.getWorld().spawnParticle(Particle.DRAGON_BREATH, center, 4, 0.2, 0.2, 0.2, 0.01);
                for (Entity ent : center.getWorld().getNearbyEntities(center, radius, radius, radius)) {
                    if (ent instanceof LivingEntity && !ent.equals(p)) {
                        com.itemedit.full.utils.EffectUtils.knockback((LivingEntity) ent, center, -pullForce, 0.05);
                    }
                }
            }
        }.runTaskTimer(plugin, center, 0L, 2L);
        ...
        }.runTaskLater(plugin, center, 40L);
        return true;
    }
}
class MagneticDraw extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        Location loc = p.getLocation();
        double radius = getDoubleParam(i, "radius", 10.0);
        p.getWorld().playSound(loc, Sound.BLOCK_BEACON_POWER_SELECT, 1.2f, 1.4f);
        com.itemedit.full.utils.EffectUtils.ring(loc.clone().add(0, 1, 0), 1.5, 16,
            new com.itemedit.full.utils.EffectUtils.Layer(Particle.END_ROD, 2, 0.05, 0.05, 0.05, 0.01));
        int pulled = 0;
        for (Entity ent : loc.getWorld().getNearbyEntities(loc, radius, radius, radius)) {
            if (ent instanceof Arrow || ent instanceof Trident) {
                Vector pull = com.itemedit.full.utils.VectorUtils.safeNormalize(loc.toVector().subtract(ent.getLocation().toVector())).multiply(1.4);
                ent.setVelocity(pull);
                ent.getWorld().spawnParticle(Particle.PORTAL, ent.getLocation(), 4, 0.05, 0.05, 0.05, 0.02);
                pulled++;
            }
        }
        if (pulled > 0) {
            loc.getWorld().spawnParticle(Particle.CRIT_MAGIC, loc.clone().add(0, 1, 0), 15, 0.5, 0.5, 0.5, 0.05);
        }
        return true;
    }
}
class ToxicSlash extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        ...
        final LivingEntity le = (target instanceof LivingEntity) ? (LivingEntity) target : null;
        double damage = getDoubleParam(i, "damage", 4.0);
        int poisonDuration = getIntParam(i, "poison_duration", 140);
        int poisonAmp = getIntParam(i, "poison_amplifier", 2);
        Location loc = (le != null) ? le.getLocation().add(0, 1, 0) : p.getEyeLocation().add(p.getLocation().getDirection().normalize().multiply(3));
        p.getWorld().playSound(p.getLocation(), Sound.ENTITY_SLIME_ATTACK, 1.0f, 0.7f);
        com.itemedit.full.utils.EffectUtils.burst(loc,
            new com.itemedit.full.utils.EffectUtils.Layer(Particle.SPELL_WITCH, 8, 0.3, 0.4, 0.3, 0.0),
            new com.itemedit.full.utils.EffectUtils.Layer(Particle.REDSTONE, 20, 0.3, 0.4, 0.3, 0.0,
                new Particle.DustOptions(Color.fromRGB(50, 205, 50), 1.3f)));
        if (le != null) {
            le.damage(damage, p);
            le.addPotionEffect(new PotionEffect(PotionEffectType.POISON, poisonDuration, poisonAmp));
        }
        return true;
    }
}
class WitherCleave extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        ...
        final LivingEntity le = (target instanceof LivingEntity) ? (LivingEntity) target : null;
        double damage = getDoubleParam(i, "damage", 6.0);
        int witherDuration = getIntParam(i, "wither_duration", 100);
        int witherAmp = getIntParam(i, "wither_amplifier", 1);
        Location loc = (le != null) ? le.getLocation().add(0, 1, 0) : p.getEyeLocation().add(p.getLocation().getDirection().normalize().multiply(3));
        p.getWorld().playSound(p.getLocation(), Sound.ENTITY_WITHER_HURT, 1.0f, 1.4f);
        com.itemedit.full.utils.EffectUtils.burst(loc,
            new com.itemedit.full.utils.EffectUtils.Layer(Particle.SMOKE_LARGE, 15, 0.3, 0.4, 0.3, 0.02),
            new com.itemedit.full.utils.EffectUtils.Layer(Particle.SOUL, 12, 0.3, 0.4, 0.3, 0.02));
        com.itemedit.full.utils.EffectUtils.ring(loc, 1.2, 12,
            new com.itemedit.full.utils.EffectUtils.Layer(Particle.SOUL_FIRE_FLAME, 2, 0.05, 0.05, 0.05, 0.01));
        if (le != null) {
            le.damage(damage, p);
            le.addPotionEffect(new PotionEffect(PotionEffectType.WITHER, witherDuration, witherAmp));
        }
        return true;
    }
}
class PhoenixStrike extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        ...
        final LivingEntity le = (target instanceof LivingEntity) ? (LivingEntity) target : null;
        double damage = getDoubleParam(i, "damage", 6.0);
        double healAmount = getDoubleParam(i, "heal_amount", 4.0);
        int fireTicks = getIntParam(i, "fire_ticks", 60);
        Location loc = (le != null) ? le.getLocation().add(0, 1, 0) : p.getEyeLocation().add(p.getLocation().getDirection().normalize().multiply(3));
        p.getWorld().playSound(p.getLocation(), Sound.ENTITY_PLAYER_ATTACK_STRONG, 1.0f, 1.3f);
        com.itemedit.full.utils.EffectUtils.burst(loc,
            new com.itemedit.full.utils.EffectUtils.Layer(Particle.FLAME, 20, 0.3, 0.4, 0.3, 0.03),
            new com.itemedit.full.utils.EffectUtils.Layer(Particle.LAVA, 6, 0.3, 0.3, 0.3, 0.02));
        com.itemedit.full.utils.EffectUtils.ring(p.getLocation().add(0, 0.1, 0), 1.3, 14,
            new com.itemedit.full.utils.EffectUtils.Layer(Particle.FLAME, 2, 0.05, 0.05, 0.05, 0.01));
        p.getWorld().playSound(p.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 0.8f, 1.6f);
...
class TempestStrike extends Ability {
    private final ItemEditFull plugin;
    public TempestStrike(ItemEditFull pl) { super("tempest_strike", "Tempest Strike", "Thunder cloud."); this.plugin = pl; }
    @Override public boolean trigger(Player p, ItemStack i) {
        Block b = p.getTargetBlock(null, 15);
        Location loc = (b != null && b.getType() != Material.AIR) ? b.getLocation().add(0.5, 1.0, 0.5)
                : p.getEyeLocation().add(p.getLocation().getDirection().normalize().multiply(8));
        double radius = getDoubleParam(i, "radius", 3.5);
        double damage = getDoubleParam(i, "damage", 7.0);
        p.getWorld().playSound(loc, Sound.ENTITY_PHANTOM_AMBIENT, 1.2f, 0.4f);
        com.itemedit.full.utils.EffectUtils.ring(loc.clone().add(0, 3, 0), radius, 20,
            new com.itemedit.full.utils.EffectUtils.Layer(Particle.CLOUD, 3, 0.2, 0.2, 0.2, 0.02));
        new CompatRunnable() {
            @Override public void run() {
                loc.getWorld().strikeLightning(loc);
                com.itemedit.full.utils.EffectUtils.burst(loc,
                    new com.itemedit.full.utils.EffectUtils.Layer(Particle.CLOUD, 20, 1.0, 0.3, 1.0, 0.05),
                    new com.itemedit.full.utils.EffectUtils.Layer(Particle.FLASH, 1, 0.0, 0.0, 0.0, 0.0));
                for (Entity ent : loc.getWorld().getNearbyEntities(loc, radius, 3.0, radius)) {
                    if (ent instanceof LivingEntity && !ent.equals(p)) {
                        ((LivingEntity) ent).damage(damage, p);
                    }
                }
            }
        }.runTaskLater(plugin, loc, 15L);
        return true;
    }
}
...
class VolcanicRupture extends Ability {
    private final ItemEditFull plugin;
    public VolcanicRupture(ItemEditFull pl) { super("volcanic_rupture", "Volcanic Rupture", "Magma spewer."); this.plugin = pl; }
    @Override public boolean trigger(Player p, ItemStack i) {
        Location loc = p.getLocation();
        double radius = getDoubleParam(i, "radius", 5.0);
        double damage = getDoubleParam(i, "damage", 5.0);
        ...
        com.itemedit.full.utils.EffectUtils.staggered(plugin, p, 4, 4L, index -> {
            Location spout = com.itemedit.full.utils.EffectUtils.jitterXZ(loc, radius * 2);
            spout.getWorld().playSound(spout, Sound.BLOCK_LAVA_POP, 1.0f, 0.8f);
            com.itemedit.full.utils.EffectUtils.burst(spout,
                new com.itemedit.full.utils.EffectUtils.Layer(Particle.LAVA, 6, 0.3, 0.2, 0.3, 0.02),
                new com.itemedit.full.utils.EffectUtils.Layer(Particle.FLAME, 15, 0.3, 0.6, 0.3, 0.04),
                new com.itemedit.full.utils.EffectUtils.Layer(Particle.SMOKE_LARGE, 8, 0.3, 0.4, 0.3, 0.02));
            for (Entity ent : spout.getWorld().getNearbyEntities(spout, 1.8, 1.8, 1.8)) {
                if (ent instanceof LivingEntity && !ent.equals(p)) {
                    LivingEntity le = (LivingEntity) ent;
                    le.damage(damage, p);
                    le.setFireTicks(fireTicks);
...
class BreezeBurstStrike extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        ...
        double radius = getDoubleParam(i, "radius", 4.0);
        double damage = getDoubleParam(i, "damage", 4.0);
        double pushMultiplier = getDoubleParam(i, "push_multiplier", 1.6);
        p.getWorld().playSound(loc, Sound.ENTITY_BREEZE_WIND_CHARGE_BURST, 1.2f, 1.2f);
        com.itemedit.full.utils.EffectUtils.ring(loc.clone().add(0, 1, 0), radius, 20,
            new com.itemedit.full.utils.EffectUtils.Layer(Particle.CLOUD, 3, 0.1, 0.2, 0.1, 0.03));
        com.itemedit.full.utils.EffectUtils.burst(loc.clone().add(0, 1, 0),
            new com.itemedit.full.utils.EffectUtils.Layer(Particle.CLOUD, 20, 0.5, 0.5, 0.5, 0.08));
        for (Entity ent : loc.getWorld().getNearbyEntities(loc, radius, 2.0, radius)) {
            if (ent instanceof LivingEntity && !ent.equals(p)) {
                LivingEntity le = (LivingEntity) ent;
                le.damage(damage, p);
                le.setVelocity(dir.clone().multiply(pushMultiplier).setY(0.4));
            }
        }
        return true;
    }
            ...
            @Override public void run() {
                ...
                for (Entity ent : loc.getWorld().getNearbyEntities(loc, radius, radius, radius)) {
                    if (ent instanceof Projectile) {
                        Vector push = com.itemedit.full.utils.VectorUtils.safeNormalize(ent.getLocation().toVector().subtract(loc.toVector())).multiply(1.2);
                        ...
                        Vector push = com.itemedit.full.utils.VectorUtils.safeNormalize(ent.getLocation().toVector().subtract(loc.toVector())).multiply(0.5).setY(0.1);
                        ent.setVelocity(push);
                    }
                }
            }
        ...
        new CompatRunnable() {
            ...
            @Override public void run() {
                ...
                for (Entity ent : center.getWorld().getNearbyEntities(center, radius, 3.0, radius)) {
                    if (ent instanceof LivingEntity && !ent.equals(p)) {
                        LivingEntity le = (LivingEntity) ent;
                        Vector pull = com.itemedit.full.utils.VectorUtils.safeNormalize(center.toVector().subtract(le.getLocation().toVector())).multiply(pullForce);
                        le.setVelocity(pull);
...
class ToadTongue extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        ...
        Vector dir = com.itemedit.full.utils.VectorUtils.safeNormalize(pLoc.toVector().subtract(tLoc.toVector()));
...
class StrawDollResonance extends Ability {
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        ...
        Vector dir = com.itemedit.full.utils.VectorUtils.safeNormalize(tLoc.toVector().subtract(pLoc.toVector()));
    ...
    @Override public boolean trigger(Player p, ItemStack i) {
        ...
        for (Entity ent : loc.getWorld().getNearbyEntities(loc, 3.0, 1.5, 3.0)) {
            if (ent instanceof LivingEntity && !ent.equals(p)) {
                LivingEntity le = (LivingEntity) ent;
                le.damage(damage, p);
                le.setVelocity(com.itemedit.full.utils.VectorUtils.safeNormalize(le.getLocation().toVector().subtract(loc.toVector())).multiply(1.0).setY(0.35));
            }
        }
        return true;
    }
...
class BloodSupernova extends Ability {
    private final ItemEditFull plugin;
    public BloodSupernova(ItemEditFull pl) { super("blood_supernova", "Blood Supernova", "Blood burst bomb."); this.plugin = pl; }
    @Override public boolean trigger(Player p, ItemStack i) {
